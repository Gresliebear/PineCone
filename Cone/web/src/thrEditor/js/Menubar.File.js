...
import { zipSync, strToU8 } from '../../../../../../three.js/examples/jsm/libs/fflate.module.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { ColladaExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { GLTFExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		const { OBJExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { STLExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( '../../../../../../three.js/examples/jsm/exporters/USDZExporter.js' );
